package com.knowledge.base.graph.filter;

import com.knowledge.base.common.result.Result;
import com.knowledge.base.common.utils.UserContextUtil;
import com.knowledge.base.graph.dto.TokenValidateVO;
import com.knowledge.base.graph.feign.UserAuthFeignClient;
...
/**
 * JWT authentication filter (dedicated to the graph service)
 *
 ...
 * (Spring Security config was anyRequest().permitAll()), so a request that reached
 * kb-graph without going through the gateway (internal network, misrouted gateway
 * path) could invoke destructive endpoints like document graph deletion and cache
 * eviction with zero authentication.</p>
 *
 * @author airwzz999
 * @since 1.0.0
 */
