package com.knowledge.base.statistics.filter;

import com.knowledge.base.common.result.Result;
import com.knowledge.base.common.utils.UserContextUtil;
import com.knowledge.base.statistics.dto.TokenValidateVO;
import com.knowledge.base.statistics.feign.UserAuthFeignClient;
...
/**
 * JWT authentication filter (dedicated to the statistics service)
 *
 ...
 * (Spring Security config was anyRequest().permitAll()), so system-wide analytics
 * (document trends, user activity, overview data) were readable by anything that
 * could reach the service directly, with zero authentication.</p>
 *
 * @author airwzz999
 * @since 1.0.0
 */
