...
import com.knowledge.base.ai.client.UserAuthFeignClient;
import com.knowledge.base.ai.dto.TokenValidateVO;
...
/**
 * JWT authentication filter (dedicated to the AI service)
 *
 ...
 * controller read X-User-Id directly - a request that reached kb-ai without going
